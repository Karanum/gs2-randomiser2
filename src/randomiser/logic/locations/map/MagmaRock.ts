...
const location : LogicMapLocation = {
    ...
    items: [
        ...
        { flag: 0x9FA, restrictions: Restriction.EVENT, access: [[Progression.MAGMA_ROCK_INTERIOR, Progression.PSY_WHIRLWIND]] },
        { flag: 0xE77 },
        ...
        { flag: 0xFF0, access: [[Progression.MAGMA_ROCK_INTERIOR]] },
        { flag: 0xFF1, access: [[Progression.MAGMA_ROCK_INTERIOR]] },
        { flag: 0xFF2, access: [[Progression.MAGMA_ROCK_INTERIOR, Progression.PSY_WHIRLWIND]] },
        { flag: 0xFF4, access: [[Progression.MAGMA_ROCK_INTERIOR, Progression.PSY_WHIRLWIND]] }
    ],

    djinn: [
        { flag: 0x5E, access: [[Progression.MAGMA_ROCK_INTERIOR]] },
        { flag: 0x68, access: [[Progression.MAGMA_ROCK_INTERIOR]] }
    ],
