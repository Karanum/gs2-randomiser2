...
function applyKandorean(mapCode) {
    ...
    // Code for skipping the Master Poi cutscene after taking the item
...
/** TODO: Figure out why the Briggs prompt dialogue box isn't persisting **/
function applyBriggs(mapCode) {
    mapCode[0] = true;

    // Code for skipping the Briggs pre-battle cutscene
    applyMapCode(mapCode[1], 0x4F4, [0x0, 0xB5, 0x0, 0x20, 0x2, 0xF0, 0xA2, 0xFE, 0x4, 0x20, 0x0, 0x21, 0x0, 0x22, 0x0, 0x23, 0x2, 0xF0,
        0xA8, 0xFE, 0x1B, 0x20, 0x0, 0x2, 0x67, 0x30, 0x0, 0x21, 0x2, 0xF0, 0xC6, 0xFE, 0x4, 0x20, 0x0, 0x21, 0x2, 0xF0, 0x12, 0xFE, 0x0,
    ...
    // Code for skipping the Briggs post-battle cutscene
...
function applyJupiterAerie(mapCode) {
    ...
    // Code for skipping the Agatio & Karst battle cutscene
