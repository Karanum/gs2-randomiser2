...
function apply(rom) {
    ...
    writeArray(rom, iconAddr, [0x0, 0xE6, 0xB7, 0x0, 0xB6, 0x53, 0x55, 0x5, 0x40, 0x97, 0x6E, 0x0, 0xBA, 0xD3, 0xA2, 0x1A, 0x8, 0xBA, 0x15, 0x8D, 0x86, 
        ...
        0x95, 0x41, 0x86, 0x8C, 0xC, 0x32, 0x32, 0x10, 0x1A, 0xA1, 0x0, 0x52, 0x52, 0x0, 0x10, 0x1, 0x0, 0x0, 0xFE, 0xFF]);

    // Move the psynergy icon table so we have more room
    moveIconTable(rom);
    write32b(rom, 0x3D4DC, 0x08000000 + tableAddr + 0x434);
    ...
    writeArray(rom, tableAddr + 0x410, [0x0, 0xB0, 0xFF, 0x8, 0x4E, 0xB0, 0xFF, 0x8, 0x98, 0xB0, 0xFF, 0x8, 0xE0, 0xB0, 0xFF, 0x8,0x33, 0xB1, 0xFF, 0x8, 
        0x7F, 0xB1, 0xFF, 0x8, 0xCA, 0xB1, 0xFF, 0x8, 0xF, 0xB2, 0xFF, 0x8, 0x64, 0xB2, 0xFF, 0x8, 0xFF, 0xFF, 0xFF, 0xFF]);
}
