...
function apply(rom, text) {
    rom[0xCE7C1] = 0x68;
    writeBytes(rom, 0xCE7C9, [0x60, 0x1, 0x48, 0x0, 0x47, 0x0, 0x0, 0x1, 0xC0, 0xFF, 0x8]);

    writeBytes(rom, 0xFFC000, [0x8, 0x48, 0x1, 0x1C, 0x8, 0x88, 0x4, 0x21, 0x8, 0x40, 0x0, 0x28, 0x7, 0xD0, 0xD0, 0x20, 0x0, 0x1, 
...
function writeBytes(rom, offset, data) {
